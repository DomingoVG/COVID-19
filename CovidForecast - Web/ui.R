...
source("getDataGithub.R") #makes data available to the instance.
      ...
      tabPanel("Forecast",
             ...
             sidebarLayout(
               sidebarPanel(
                 ...
                 sliderInput(inputId = "fitWinSlider", min = 1, max = 15, value = 7, ticks = FALSE, label = "Fit window:", post = " days"),
                 hr(),
